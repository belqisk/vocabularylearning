 ...
 * 单词学习页面，处理单词过滤、切换和学习逻辑。
 * Word learning page, handling word filtering, switching, and learning logic.
 * 
 * 逻辑修改点 (Logic Mod Points):
 * - 使用 next/navigation hooks (useRouter, useSearchParams).
 * - Use next/navigation hooks.
 * - 将内容包裹在 Suspense 中以处理异步参数。
 * - Wrap content in Suspense to handle async params.
 */

const WordsContent: React.FC = () => {
  ...
  }, [currentIndex, sessionWords, currentWord]);
