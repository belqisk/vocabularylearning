    ...
    <div className="flex flex-col min-h-screen pb-20">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4 mb-8">
          <Link to="/words?filter=all" className="group bg-primary text-white p-6 rounded-2xl shadow-lg shadow-amber-200/50 dark:shadow-none hover:scale-105 transition-transform duration-200 flex flex-col justify-between h-40">
          ...
          <Link to="/words?filter=unlearned" className="group bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-primary/50 dark:hover:border-primary/50 hover:shadow-md transition-all duration-200 flex flex-col justify-between h-40">
          ...
          <Link to="/words?filter=favorites" className="group bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-primary/50 dark:hover:border-primary/50 hover:shadow-md transition-all duration-200 flex flex-col justify-between h-40">
